      ...
      <div className="relative h-full w-full">
        ...
        >
          {state.routes.map((route, index) => {
            ...
            const screenOptionsProp = screens[route.name as string].options;
            const screenOptions =
              typeof screenOptionsProp === "function"
                ? screenOptionsProp({ route: route as any })
                : screenOptionsProp || {};
            ...
            const animationOption = screenOptions.animation || "default";

            const animationConfig =
              typeof animationOption === "string"
                ? STACK_TRANSITIONS[animationOption] ||
                  STACK_TRANSITIONS.default
                : animationOption;
            console.log(route, isActive, variantName);
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow:
                    typeof animationOption === "string" &&
                    animationOption.startsWith("slide") &&
                    isActive
...
### Source: `src\lib\hooks\useStackRouter.tsx`
