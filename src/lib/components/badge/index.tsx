...
const badgeVariants = cva(
  "inline-flex items-center border select-none cursor-pointer px-2 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2",
  {
    variants: {
      variant: {
        primary:
