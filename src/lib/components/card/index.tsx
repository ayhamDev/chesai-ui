  ...
  "transition-all duration-300 ease-out relative z-0 overflow-hidden",
  {
    ...
    compoundVariants: [
      ...
      // --- Glass Variants ---
      {
        ...
        variant: "primary",
        className:
          "bg-surface-container-low/60 backdrop-blur-2xl shadow-xl border border-outline-variant/30",
      },
      {
        glass: true,
        variant: "secondary",
        className:
          "bg-surface-container-highest/60 backdrop-blur-2xl shadow-xl border border-outline-variant/30",
      },
      {
        glass: true,
        variant: "tertiary",
        className:
          "bg-tertiary-container/60 backdrop-blur-2xl shadow-xl border border-outline-variant/30",
      },
      {
        glass: true,
        variant: "high-contrast",
        className:
          "bg-inverse-surface/60 backdrop-blur-2xl shadow-xl border border-outline-variant/30",
      },
      {
        glass: true,
        variant: "ghost",
        className:
          "backdrop-blur-2xl shadow-xl border border-outline-variant/30",
      },
      {
        glass: true,
        variant: "surface",
        className:
          "bg-surface/60 backdrop-blur-2xl shadow-xl border border-outline-variant/30",
      },
      {
        glass: true,
        variant: "surface-container-lowest",
        className:
          "bg-surface-container-lowest/60 backdrop-blur-2xl shadow-xl border border-outline-variant/30",
      },
      {
        glass: true,
        variant: "surface-container-low",
      ...
      },
      {
        ...
        variant: "surface-container",
        className:
          "bg-surface-container/60 backdrop-blur-2xl shadow-xl border border-outline-variant/30",
      },
      {
        glass: true,
        variant: "surface-container-high",
        className:
          "bg-surface-container-high/60 backdrop-blur-2xl shadow-xl border border-outline-variant/30",
      },
      {
        glass: true,
        variant: "surface-container-highest",
